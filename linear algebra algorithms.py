...
def determinant(mat: Matrix):
    ...
    sum_diagonals = sum_diagonals * (-1) ** swaps
    if sum_diagonals.denominator == 1:
        return int(sum_diagonals)
    return "determinant is {deter} or about {frac}".format(deter=sum_diagonals,
                                                           frac=float(
                                                               sum_diagonals))
